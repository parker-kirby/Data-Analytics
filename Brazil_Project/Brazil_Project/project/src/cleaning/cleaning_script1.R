...
#read in our data
data <- fread('./Brazil_Project/project/volume/data/raw/raw_data.csv')

'%notin%' <- Negate('%in%')

remove <- c( "Member Status Update Date", "Member First Responded Date", "Member")
...
fwrite(data, './Brazil_Project/project/volume/data/interim/cleaned_data.csv')
